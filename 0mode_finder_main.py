...
profile_name = 'DIIID175823.iterdb' 		#name of the profile file
                                            #DIIID175823.iterdb
                                            #p000000
geomfile_name = 'tracer_efit_0001'           #name of the magnetic geometry file
                                            #g000000
                                            #tracer_efit.dat
Efit_name="g175823.04108_257x257"

suffix='0001'                   #The suffix if one choose to use GENE_tracor for q profile
                                #0001, 1, dat

f_max=150      #upper bound of the frequency experimentally observed 
...
midped, topped=find_pedestal_from_data(uni_rhot,te_u+ne_u,tprime_e+nprime_e,plot=False)
x0_center = midped
...
Lref, Bref, R_major, q0, shat0=get_geom_pars(Efit_name,x0_center)
