...
-3.38286, -4.04026]]])
    ...
    VZArray=(Zeff**2-1)*np.array([[[-0.752253, -0.71365, -0.674336, -0.642358, -0.61628, -0.594565, \
...
def w_finder(x_max, del_x, w_guess, v,Zeff,ne,alpha,beta,ky,ModIndex,mu,xstar):
...
def Dispersion(nu,Zeff,eta,shat,beta,ky,ModIndex,mu,xstar):
  ...
  w0=w_finder(xmax,delx,1+eta+nu/10.,nu,Zeff,eta,shat,beta,ky,ModIndex,mu,xstar)
  print("****************")
  print("****************")
  print("****************")
  print("****************")
