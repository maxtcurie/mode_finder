...
plt.clf()
xgrid, q = read_geom_file("gfile",geomfile_name,suffix)
plt.plot(xgrid, q*0.96,label="gfile")
xgrid, q, Lref, Bref, x0_from_para = read_geom_file("GENE_tracor",gene_geomfile_name,suffix)
